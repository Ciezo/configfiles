...
New-Alias -Name "ll" ls
New-Alias -Name "bash" -Value "C:\Program Files\Git\usr\bin\bash.exe"
New-Alias -Name "sh" -Value "C:\Program Files\Git\usr\bin\bash.exe"
...
New-Alias -Name "tig" -Value "C:\Program Files\Git\usr\bin\tig.exe"
New-Alias -Name "du" -Value "C:\Program Files\Git\usr\bin\du.exe"
New-Alias -Name "work-st" -Value WorkStationState
